...
sed -i 's/$hostname-2.4G/BYQ/g' package/mtk/drivers/wifi-profile/files/common/mt7981/lib/wifi/mtk.sh
sed -i 's/OpenWRT-2.4G/BYQ/g' package/mtk/drivers/wifi-profile/files/common/mt7981/lib/wifi/mtk.sh
...
sed -i 's/$hostname-5G/BYQ/g' package/mtk/drivers/wifi-profile/files/common/mt7981/lib/wifi/mtk.sh
sed -i 's/OpenWRT-5G/BYQ/g' package/mtk/drivers/wifi-profile/files/common/mt7981/lib/wifi/mtk.sh
